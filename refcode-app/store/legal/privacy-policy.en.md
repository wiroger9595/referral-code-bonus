...
The Service is provided by {{開發者姓名}} ("we", "us") as an individual developer.
...
| | |
|---|---|
| Controller | {{開發者姓名}} (individual developer) |
| Contact | {{聯絡email}} |
| Website | https://{{官網網域}} |
...
For anything else, email {{聯絡email}}. We respond within 30 days.
...
If you believe a child has provided us with personal data, email {{聯絡email}} and we will delete it.
